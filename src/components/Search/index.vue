    ...
    <div class="search_body">
        <div class="search_input">
            <div class="search_input_wrapper">
                ...
                <input type="text" ref="input1" v-model="message" placeholder="请输入搜索内容" />
            </div>
        </div>
        <div class="search_result">
            <h3>电影/电视剧/综艺</h3>
            <ul>
                <li v-for="item in searchList" :key="item.id" v-if="Result">
                    <div class="img">
                ...
                <li v-if="!Result" style="text-align:center">
                    <h1>{{tips}}</h1>
                </li>
            </ul>
        </div>
